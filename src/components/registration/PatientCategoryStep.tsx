...
import { Users, UserCheck, Stethoscope, Building, Guitar as Hospital, Shield } from 'lucide-react';
...
function PatientCategoryStep({ data, updateData, onNext }: PatientCategoryStepProps) {
  const categories = [
    {
      id: 'walk-in',
      label: 'Walk-in',
  ...
  return (
    <div>
      <div className="mb-6">
        <h2 className="text-2xl font-bold text-gray-900 mb-2">Patient Category</h2>
        <p className="text-gray-600">What category does the patient fall into?</p>
      </div>
