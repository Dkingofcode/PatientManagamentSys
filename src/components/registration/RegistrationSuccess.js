...
function RegistrationSuccess({ patientId, appointmentId, registrationData, }) {
    ...
    return (<div className="bg-white rounded-lg shadow-lg overflow-hidden">
      ...
      <div className="p-8">
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <button onClick={generateQRCode} className="flex items-center space-x-2 px-3 py-2 bg-gray-100 hover:bg-gray-200 rounded-lg transition-colors">
                  <QrCode size={16}/>
        ...
        <div className="bg-gray-50 rounded-lg p-6 mb-6">
          ...
          <div className="space-y-3">
            {registrationData.tests?.map((test, index) => (<div key={index} className="flex items-center justify-between py-2 border-b border-gray-200 last:border-b-0">
                <div>
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          <button onClick={() => navigate("/front-desk")} className="flex items-center justify-center space-x-2 px-6 py-3 bg-gray-600 text-white rounded-lg hover:bg-gray-700 transition-colors">
            <ArrowLeft size={20}/>
            <span>Back to Dashboard</span>
          </button>

          <button onClick={downloadSummary} className="flex items-center justify-center space-x-2 px-6 py-3 bg-blue-600 text-white rounded-lg hover:bg-blue-700 transition-colors">
            <Download size={20}/>
            <span>Download Summary</span>
          </button>

          <button onClick={() => window.print()} className="flex items-center justify-center space-x-2 px-6 py-3 bg-purple-700 text-white rounded-lg hover:bg-purple-800 transition-colors">
            <FileText size={20}/>
