  ...
  return (
    <div className="p-4 md:p-6">
        ...
        <div>
          ...
          <div className="relative mb-4 md:mb-6">
            ...
            <input
              ...
              className="w-full pl-9 pr-4 py-2 md:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
            />
          </div>
          ...
          <div>
            ...
            <div className="mb-4 md:mb-6">
              ...
              {selectedPaymentMethod && selectedPaymentMethod !== 'credit' && (
                <div className="space-y-2 md:space-y-4 mb-4 md:mb-6">
                  ...
                  {getPaymentMethods().map((methodId) => {
                    ...
                    return (
                      <div key={methodId} className="flex items-center space-x-2 md:space-x-4">
                        ...
                        <div className="flex-1">
                          <div className="relative">
                            ...
                            <input
                              ...
                              className="w-full pl-6 md:pl-8 pr-2 md:pr-4 py-2 md:py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                              placeholder="0.00"
                            />
                          </div>
                        </div>
              ...
              {selectedPaymentMethod === 'credit' && (
                <div className="mt-3 md:mt-4 p-3 md:p-4 bg-orange-50 rounded-lg border border-orange-200 mb-4 md:mb-6">
                  <div className="flex items-center justify-between mb-2 md:mb-3">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-24 md:w-32 pl-6 md:pl-8 pr-2 md:pr-3 py-2 border border-orange-300 rounded-lg text-xs md:text-sm focus:outline-none focus:ring-2 focus:ring-orange-500"
                        placeholder="0.00"
                      />
                    </div>
                  </div>
            ...
            {selectedPaymentMethod && (
              <div className="bg-white border border-gray-200 rounded-lg p-4 md:p-6 mb-4 md:mb-8">
            ...
            {selectedPaymentMethod && (
              <div className="bg-blue-50 rounded-lg p-3 md:p-4 mb-4 md:mb-8">
            ...
            <div className="flex justify-between">
              <button
                onClick={prevStep}
                className="px-4 py-2 md:px-6 md:py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors"
              >
                Previous
              </button>
              <button
                ...
                className="px-4 py-2 md:px-6 md:py-2 bg-purple-800 text-white rounded-lg hover:bg-purple-900 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
              >
                Complete Booking
              </button>
            </div>
      ...
      <CategoryModal
        ...
        initialCategory={pendingPatient?.category || 'general'}
      />
    </div>
  );
}
