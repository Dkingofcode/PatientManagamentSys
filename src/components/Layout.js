        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-wrap justify-between items-center h-auto py-2 gap-y-4 sm:gap-y-0">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-end space-x-4">
              ...
              {user?.role === "admin" && (<Link to="/admin" className="flex items-center space-x-1 px-3 py-2 rounded-lg bg-blue-100 text-blue-700 hover:bg-blue-200 transition" title="Go to Admin Dashboard">
                  <Home size={16}/>
              ...
              <div className="flex items-center space-x-3">
                ...
                <button onClick={logout} className="p-2 text-gray-400 hover:text-[#3065B5] transition-colors" title="Logout">
                  <LogOut size={20}/>
                </button>
              </div>
            </div>
