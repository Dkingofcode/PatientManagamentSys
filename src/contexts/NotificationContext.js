...
export function NotificationProvider({ children }) {
    ...
    const getNotificationsByRole = (role) => {
        return notifications.filter((notification) => notification.recipientRole === role ||
    ...
    const triggerPatientRegistration = (patientData) => {
        addNotification({
    ...
    const triggerAppointmentBooked = (appointmentData) => {
        // Notify doctor
        addNotification({
    ...
    const triggerLabTestBooked = (labData) => {
        addNotification({
    ...
    const triggerXrayTestBooked = (xrayData) => {
        addNotification({
    ...
    const triggerInventoryAlert = (inventoryData) => {
        ...
        addNotification({
            ...
            message: `${inventoryData.item} is ${isCritical ? "critically low" : "running low"} (${inventoryData.stock} remaining)`,
