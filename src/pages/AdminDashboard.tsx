        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="p-2 rounded-md bg-gray-200 hover:bg-gray-300 inline-flex items-center"
            >
              <Menu size={20} />
            </button>
          ...
          <div className="flex items-center space-x-4">
            {/* Demo Button */}
            <button
              onClick={simulatePatientRegistration}
            ...
            <div className="relative">
              <button
                ...
                className="relative p-2 text-gray-400 hover:text-gray-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2 rounded-full bg-white shadow-sm border border-gray-200"
              >
                <Bell size={20} />
        ...
        {showSidebar && (
          <div className="fixed inset-0 z-40">
            ...
            >
              <button
                onClick={() => setShowSidebar(false)}
                className="mb-4 p-2 bg-gray-100 rounded hover:bg-gray-200"
              >
                Close
              </button>
              <SettingsSidebar />
