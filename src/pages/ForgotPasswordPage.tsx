...
function ForgotPasswordPage() {
  ...
  const handlEmailPasswordSubmit = (e: React.FormEvent) => {
    e.preventDefault();
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex items-center justify-center border-2 border-purple-200 px-4">
      <div className="max-w-md w-full bg-white p-8 rounded-lg border-[8px] border-purple-100 shadow-lg">
        ...
        {!passwordChanged ? (
          <form onSubmit={handlEmailPasswordSubmit} className="space-y-5">
            <div>
              <label
                htmlFor="email"
              ...
              <input
                ...
                required
                className="w-full px-4 py-3 bg-gray-50 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-400"
            ...
            <button
              type="submit"
              className="w-full py-3 px-4 font-medium rounded-lg bg-purple-700 text-white hover:bg-purple-800 transition"
            >
              Reset Password
            </button>
