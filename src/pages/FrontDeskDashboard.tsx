        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="bg-white rounded-lg shadow p-5 flex justify-between items-center">
            <div>
              ...
              <p className="text-2xl font-semibold text-gray-900">{myPatients.length}</p>
            </div>
            <IconWrapper><Users size={25} className="text-gray-600" /></IconWrapper>
          </div>
          <div className="bg-white rounded-lg shadow p-5 flex justify-between items-center">
            <div>
              <p className="text-sm text-gray-600">Today's Registrations</p>
              <p className="text-2xl font-semibold text-gray-900">{todayRegistrations.length}</p>
            </div>
            <IconWrapper><UserPlus size={25} className="text-gray-600" /></IconWrapper>
          </div>
          <div className="bg-white rounded-lg shadow p-5 flex justify-between items-center">
            <div>
            ...
            <IconWrapper><CalendarDays size={25} className="text-gray-600" /></IconWrapper>
          </div>
          <div className="bg-white rounded-lg shadow p-5 flex justify-between items-center">
            <div>
            ...
            <IconWrapper><Clock size={25} className="text-gray-600" /></IconWrapper>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          <div className="bg-white rounded-lg shadow">
            <div className="p-5 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">My Patient Directory</h2>
              <p className="text-sm text-gray-500">Patients registered by iouytryu</p>
            </div>
            <div className="p-5">
                  ...
                  filteredPatients.map(patient => (
                    <div key={patient.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-md hover:bg-gray-50">
                      <div className="flex items-center space-x-3">
                        <IconWrapper><User size={18} className="text-gray-600" /></IconWrapper>
                        <div>
          ...
          <div className="bg-white rounded-lg shadow">
            <div className="p-5 border-b border-gray-200">
              <h2 className="text-lg font-medium text-gray-900">Today's Test Requests</h2>
              <p className="text-sm text-gray-500">Appointments from your patients</p>
            </div>
            <div className="p-5 space-y-4">
              {todayAppointments.length ? (
                todayAppointments.map(appointment => {
                  ...
                  return (
                    <div key={appointment.id} className="flex justify-between items-center p-4 bg-gray-50 rounded-md">
                      <div>
                        <h4 className="font-medium text-gray-900">{patient?.name || 'Unknown'}</h4>
                        <p className="text-sm text-gray-600">{appointment.tests.length} test{appointment.tests.length !== 1 ? 's' : ''}</p>
        ...
        <div className="bg-white rounded-lg shadow p-5">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="p-5 text-center border-2 border-dashed border-gray-200 rounded-md hover:border-gray-300">
              <IconWrapper><UserPlus size={20} className="text-gray-600" /></IconWrapper>
              <h3 className="mt-3 font-medium text-gray-900">Register Patient</h3>
              <p className="text-sm text-gray-600 mt-1">Add a new patient and request tests</p>
              <button
                onClick={() => navigate('/front-desk/register-patient')}
            ...
            <div className="p-5 text-center border-2 border-dashed border-gray-200 rounded-md hover:border-gray-300">
              <IconWrapper><Search size={20} className="text-gray-600" /></IconWrapper>
            ...
            <div className="p-5 text-center border-2 border-dashed border-gray-200 rounded-md hover:border-gray-300">
              <IconWrapper><CalendarDays size={20} className="text-gray-600" /></IconWrapper>
              <h3 className="mt-3 font-medium text-gray-900">Schedule Appointment</h3>
