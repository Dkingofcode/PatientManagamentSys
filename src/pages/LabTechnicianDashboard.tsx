...
function LabTechnicianDashboard() {
  ...
  console.log(
    "All Approved Appointments:" //getApprovedAppointments()
  );
  ...
  //   {
  //     id: 1,
  //     message: "New urgent test assigned: Blood Culture",
  //     time: "5 min ago",
  //     read: false,
  //   },
  //   {
  //     id: 2,
  //     message: "QC alert: Control sample deviation detected",
  //     time: "15 min ago",
  //     read: false,
  //   },
  //   {
  //     id: 3,
  //     message: "Sample S004 requires immediate attention",
  //     time: "30 min ago",
  //     read: true,
  //   },
  // ]);
    ...
    <Layout title="">
      <div className="space-y-6">
        ...
        <div className="flex justify-between items-start">
          <div>
            <h1 className="text-2xl font-bold text-[#3065B5]">
 ...
 // testId,
  ...
  return (
    <div className="fixed inset-0 bg-white bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg max-w-lg w-full mx-4 border-2 border-blue-500">
        <div className="p-6 border-b border-gray-200">
          <h3 className="text-lg font-semibold text-gray-900">
            Sample Details
          </h3>
